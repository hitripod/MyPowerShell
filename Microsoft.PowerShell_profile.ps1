...
#function ds
#{
#    $cmd = 'cd D:\360Tools\DownloadSign &&'
#    $cmd += 'C:\Python33\python download.py kordan &&'
#    $cmd += 'explorer D:\360Tools\DownloadSign\output && exit'
#    C:\Windows\System32\cmd.exe /k $cmd
#}
#
#function dsp
#{
#    & "C:\Program Files (x86)\360\Total Security\safemon\360SPTool.exe" /disablesp 2 
#}
#
#function tgit
#{
#    TortoiseGitProc.exe /command:$args
#}
#
...
#$global:LK = "D:\Translation\LangKit"
#
